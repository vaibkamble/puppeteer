...
export class ElementHandle extends JSHandle {
  ...
  _getQueryHandlerAndSelector(selector: string, defaultQueryHandler: QueryHandler, errorMessage: string):
    ...
    if (!queryHandler)
      throw new Error(errorMessage.replace('QUERY_HANDLER_NAME', name));
